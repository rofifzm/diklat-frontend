...
<template lang="">
  <div class="gempa p-3 mb-4">
    <div class="card p-2 rounded shadow">
      ...
      <div class="mb-2 text-center" v-if="infoGempa['Infogempa']">
        {{ infoGempa["Infogempa"]["gempa"]["Tanggal"] }}
        {{ infoGempa["Infogempa"]["gempa"]["Jam"] }}
      </div>
      <div id="map"></div>
      <div class="d-flex flex-row justify-content-around p-2">
        <div>
          <img
            ...
            height="26"
          />
          <strong class="ms-2" v-if="infoGempa['Infogempa']">{{
            infoGempa["Infogempa"]["gempa"]["Magnitude"]
          }}</strong
        ...
        <div>
          ...
          />
          <strong class="ms-2" v-if="infoGempa['Infogempa']">{{
            infoGempa["Infogempa"]["gempa"]["Kedalaman"]
          }}</strong>
        ...
        <div>
          <img
            ...
            height="26"
          />
          <strong v-if="infoGempa['Infogempa']"
            >{{ infoGempa["Infogempa"]["gempa"]["Lintang"] }}<br />{{
              infoGempa["Infogempa"]["gempa"]["Bujur"]
            }}</strong
          >
        </div>
      </div>
